    ...
    <div className="wrapper clear">
      ...
      <img width={40} height={40} src="/img/logo.png" alt="" />
          <div>
            ...
            <p className="opacity-5">Магазин лучших кросоовок</p>
          </div>
        </div>
          <ul className="d-flex">
            <li className="mr-30"> 
              <svg width="20" height="20" className="mr-10" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content p-40">
        <h1 className="mb-40">Все кроссовки</h1>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/8.png" alt="snekears" />
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/12.png" alt="snekears" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/9.png" alt="snekears" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/1.png" alt="snekears" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
